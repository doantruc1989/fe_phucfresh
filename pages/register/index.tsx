  ...
  return (
    <div className="h-screen mb-6">
      ...
      <div className="flex flex-col items-center mt-10 gap-2 w-full md:w-11/12 lg:w-9/12 mx-auto">
        ...
        <div className="mt-5">
            <p className="text-sm font-medium uppercase mb-2">Họ:</p>
            <TextInput placeholder="Nhập họ" />
          </div>
        <div className="mt-5">
            <p className="text-sm font-medium uppercase mb-2">Tên:</p>
            <TextInput placeholder="Nhập tên" />
          </div>
        <div className="mt-5">
            <p className="text-sm font-medium uppercase mb-2">Số điện thoại:</p>
          ...
          <div className="mt-5">
            <p className="text-sm font-medium uppercase mb-2">Nhập lại Mật khẩu:</p>
        ...
        <div className="mt-3 flex flex-col items-center gap-3 w-full">
          ...
          <Link className="text-sm uppercase text-green-600 font-medium mt-1" href={"/login"}>
          Đăng nhập
          </Link>
